...
import { AlertTriangle, Bluetooth, CloudRain, Database, MapPin, MessageSquare, MoreHorizontal, Navigation, PhoneCall, Radio, RefreshCw, ShieldCheck, Siren, ThermometerSun, Waves, Wifi, WifiOff } from "lucide-react";
  ...
  return <div className="victim-page min-h-screen bg-[#f6f8f7] text-[#142c2b] dark:bg-[#050505] dark:text-[#f4f4f5]"><main className="victim-main relative mx-auto min-h-screen max-w-lg overflow-hidden bg-[#fcfdfd] px-5 pb-28 pt-6 shadow-2xl shadow-[#113c35]/10 dark:bg-[#101011] dark:shadow-black/30 md:my-6 md:min-h-[850px] md:rounded-[2.75rem] md:border">
    <header className="flex items-center justify-between gap-3">
      ...
      <div className="flex flex-col items-end gap-1.5">
        ...
        <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[10px] font-extrabold ${online ? "bg-[#dff6e7] text-[#197654] dark:bg-emerald-950/60 dark:text-emerald-300" : "bg-[#fff1dd] text-[#9b6519] dark:bg-amber-950/60 dark:text-amber-300"}`}>
