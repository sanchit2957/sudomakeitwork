...
const runtime = vi.hoisted(() => ({ mutateAsync: vi.fn(), navigate: vi.fn(), startLogin: vi.fn() }));
...
vi.mock("@/lib/offlineSos", () => ({ flushOfflineSos: vi.fn().mockResolvedValue({ delivered: [] }), queueOfflineSos: vi.fn() }));
