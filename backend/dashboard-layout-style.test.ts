...
describe("DashboardLayout sidebar styling", () => {
  it("keeps the footer side panel opaque in expanded and collapsed states", () => {
    const source = readFileSync(new URL("../frontend/src/components/DashboardLayout.tsx", import.meta.url), "utf8");
  ...
  it("allows Command Centre to request a permanently expanded desktop sidebar", () => {
    const layout = readFileSync(new URL("../frontend/src/components/DashboardLayout.tsx", import.meta.url), "utf8");
    const command = readFileSync(new URL("../frontend/src/pages/Command.tsx", import.meta.url), "utf8");
    const sidebar = readFileSync(new URL("../frontend/src/components/ui/sidebar.tsx", import.meta.url), "utf8");
