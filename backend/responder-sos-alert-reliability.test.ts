...
describe("Frontend contract \u2014 activeOffer polling interval (1s)", () => {
  const responderSrc = readFileSync(
    new URL("../frontend/src/pages/Responder.tsx", import.meta.url),
    "utf8"
  );
  const userResponderSrc = readFileSync(
    new URL("../frontend/src/pages/user/UserResponder.tsx", import.meta.url),
    "utf8"
  );
...
describe("EmergencyAudioAlert \u2014 audio lifecycle contract", () => {
  const cardSrc = readFileSync(
    new URL("../frontend/src/components/EmergencyOfferCard.tsx", import.meta.url),
    "utf8"
  );
