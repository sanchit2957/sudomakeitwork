  ...
  return (
    <div className="space-y-6">
      ...
      <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#ca8a04]/30 bg-[#fefce8] px-2.5 py-0.5 font-mono text-[10px] font-bold text-[#854d0e]">
              <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#ca8a04]" />
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-3xl border bg-white p-5 shadow-sm dark:bg-[#141517]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
              Total 24h Check-Ins
            </span>
            <div className="grid h-8 w-8 place-items-center rounded-xl bg-[#fff1f2] text-[#881337] dark:bg-[#881337]/20 dark:text-[#fca5a5]">
        ...
        <div className="rounded-3xl border bg-white p-5 shadow-sm dark:bg-[#141517]">
          <div className="flex items-center justify-between">
            ...
            <div className="grid h-8 w-8 place-items-center rounded-xl bg-[#fefce8] text-[#854d0e] dark:bg-[#422006]/30 dark:text-[#fef08a]">
              <Home className="h-4 w-4" />
            </div>
          </div>
          <p className="mt-2 text-3xl font-black text-[#854d0e] dark:text-[#fef08a]">
            {reliefAllottedCount}{" "}
                  ...
                  <div className="mt-3.5 grid grid-cols-2 gap-2 text-xs">
                    <div className="rounded-2xl border border-slate-100 bg-slate-50/80 p-2.5">
                      ...
                      <div className="mt-1 flex items-center gap-1.5">
                        {isReliefYes ? (
                          <>
                            <CheckCircle2 className="h-4 w-4 text-[#ca8a04] dark:text-[#facc15]" />
                            <span className="font-bold uppercase text-[#854d0e] dark:text-[#fef08a]">
                              Allotted (Yes)
                            </span>
                          </>
                        ) : (
