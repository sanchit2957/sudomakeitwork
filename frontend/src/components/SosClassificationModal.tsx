...
export function SosClassificationModal({
  ...
  return (
    ...
    >
      <div className="relative flex w-full max-w-md max-h-[92vh] flex-col overflow-hidden rounded-[2.2rem] border border-black/10 bg-white text-foreground shadow-[0_24px_60px_rgba(136,19,55,0.22)] ring-1 ring-black/[0.04] dark:border-white/10 dark:bg-[#15171a]">
        
        {/* Top Header Bar */}
        <div className="border-b border-black/5 bg-[#fafcfb] px-6 py-4 dark:border-white/10 dark:bg-[#191b1f]">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="rounded-lg bg-[#fefce8] px-2.5 py-1 font-mono text-xs font-extrabold text-[#854d0e] dark:bg-[#422006]/40 dark:text-[#fef08a]">
              {publicCode}
            </span>
          </div>
            ...
            <div className="mt-3.5">
              <div className="flex items-center justify-between text-xs font-bold text-muted-foreground">
                <span className="flex items-center gap-1.5">
                  <Clock className="h-3.5 w-3.5 text-[#881337] dark:text-[#facc15]" />
              ...
              <div className="mt-1.5 h-2 overflow-hidden rounded-full bg-black/5 dark:bg-zinc-800">
                <div
                  className="h-full rounded-full bg-gradient-to-r from-[#d23f43] via-amber-500 to-[#881337] transition-all duration-200 ease-linear dark:from-rose-500 dark:via-amber-500 dark:to-[#facc15]"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {currentStep === "categories" ? (
                ...
                <button
                  ...
                  className={`group relative flex items-center gap-4 rounded-2xl border p-4 text-left transition-all duration-200 active:scale-[0.98] ${
                    selectedCategory === "rescue"
                      ? "border-[#881337] bg-[#fff1f2] ring-2 ring-[#881337]/40 dark:border-[#facc15] dark:bg-[#422006]/40"
                      : "border-black/10 bg-[#fbfdfc] hover:border-[#881337]/40 hover:bg-white hover:shadow-md dark:border-white/10 dark:bg-[#1a1c20] dark:hover:border-[#facc15]/40"
                  }`}
                >
                  <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-[#fff1f2] text-[#881337] transition-transform group-hover:scale-105 dark:bg-[#881337]/20 dark:text-[#fca5a5]">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      {selectedCategory === "rescue" && (
                        <CheckCircle2 className="h-5 w-5 text-[#881337] animate-in zoom-in-50 dark:text-[#facc15]" />
                      )}
                    </div>
                    <p className="mt-0.5 text-xs text-[#5f776f] dark:text-zinc-400">
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-200">
              ...
              <div className="rounded-2xl border border-[#ca8a04]/30 bg-[#fefce8] p-4 text-xs dark:border-[#ca8a04]/30 dark:bg-[#422006]/30">
                <div className="flex items-center gap-2 font-black text-[#854d0e] dark:text-[#fef08a]">
                  <Radio className="h-4 w-4 animate-pulse text-[#ca8a04] dark:text-[#facc15]" />
              ...
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#881337] hover:underline dark:text-[#facc15]"
                >
              ...
              <div className="rounded-2xl border border-black/10 bg-[#fafcfb] p-4 dark:border-white/10 dark:bg-[#16181b]">
                ...
                <div className="mt-2.5 flex items-center gap-3">
                  ...
                  <output className="grid h-9 min-w-12 place-items-center rounded-xl bg-white text-lg font-black text-[#881337] shadow-sm ring-1 ring-black/[0.04] dark:bg-[#202328] dark:text-[#facc15]">
                    {peopleAffected}
                  </output>
                  <Button
                    type="button"
                      ...
                      <button
                        ...
                        className={`rounded-full px-2.5 py-1 text-[11px] font-bold transition ${
                          isSelected
                            ...
                            : "bg-white text-[#881337] ring-1 ring-[#881337]/20 hover:bg-[#fff1f2] dark:bg-[#202328] dark:text-[#facc15] dark:ring-white/10"
                        }`}
                      >
                        {tag}
                      </button>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                <Button
                  ...
                  className="h-11 rounded-xl bg-[#881337] text-xs font-extrabold text-white shadow-md hover:bg-[#9f1239] dark:bg-[#eab308] dark:text-[#0a0b0d] dark:hover:bg-[#facc15]"
                >
