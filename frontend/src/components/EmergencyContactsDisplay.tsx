            ...
            >
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  {c.isPrimary === "yes" && (
                    <span className="inline-flex items-center gap-0.5 rounded bg-[#fef9c3] px-1.5 py-0.5 text-[10px] font-bold text-[#854d0e] dark:bg-[#451a03]/40 dark:text-[#fde047]">
              ...
              <div className="flex items-center gap-2">
                <a
                  href={`tel:${c.phone}`}
                  className="inline-flex items-center gap-1 rounded-lg bg-[#881337] px-2.5 py-1 text-xs font-bold text-white shadow-sm transition hover:bg-[#9f1239] active:scale-95"
                >
