    ...
    >
      ...
      {draft && !recording ? (
        <button
          ...
          className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[#881337] text-white shadow-sm transition active:scale-95 hover:bg-[#9f1239] dark:bg-[#eab308] dark:text-[#0a0b0d]"
        >
          {isPlaying ? (
        ...
        <button
          ...
          className={`grid h-12 w-12 shrink-0 place-items-center rounded-2xl text-white shadow-sm transition active:scale-95 disabled:opacity-50 ${
            recording ? "bg-[#881337] animate-pulse" : "bg-[#881337] hover:bg-[#9f1239] dark:bg-[#eab308] dark:text-[#0a0b0d]"
          }`}
        >
          {recording ? (
