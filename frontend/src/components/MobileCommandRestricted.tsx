...
export default function MobileCommandRestricted() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0c0a09] px-4 py-8 text-white sm:px-6">
      <div className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-[#881337]/40 bg-gradient-to-b from-[#2a0812]/95 to-[#140b0e]/98 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
        <div className="absolute -right-10 -top-10 h-36 w-36 rounded-full bg-[#881337]/20 blur-3xl" />
        <div className="absolute -left-10 -bottom-10 h-36 w-36 rounded-full bg-[#ca8a04]/15 blur-3xl" />

        {/* Icon */}
        <div className="mb-5 flex items-center justify-center">
          <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border border-[#881337]/50 bg-[#450a0a]/50 shadow-inner">
            <Monitor className="h-10 w-10 text-[#facc15]" />
            <span className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-[#0c0a09] bg-amber-500 text-black">
        ...
        <div className="text-center">
          ...
          <p className="mt-2.5 text-xs leading-relaxed text-[#fecdd3] sm:text-sm">
        ...
        <div className="mt-6 space-y-2.5 rounded-2xl border border-white/10 bg-black/30 p-4 text-left">
          <p className="font-mono text-[11px] font-bold uppercase tracking-wider text-[#facc15]">
            Why is Admin access restricted on phones?
          </p>
          
          <div className="space-y-2 text-xs text-[#fed7aa]">
            <div className="flex items-start gap-2.5">
              <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-md bg-[#881337]/40 text-[#facc15]">
        ...
        {/* Action Note */}
        <div className="mt-4 rounded-xl border border-[#ca8a04]/30 bg-[#422006]/40 p-3 text-[11px] text-[#fef08a]">
        ...
        <div className="mt-6 flex flex-col gap-2.5 sm:flex-row">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#881337] py-3 text-xs font-bold text-white shadow-md transition hover:bg-[#9f1239] active:scale-[0.98]"
          >
