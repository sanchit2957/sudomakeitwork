...
const AVATAR_PALETTE = [
  { bg: "bg-[#881337]", text: "text-white", border: "border-[#4c0519]" }, // Crimson Deep Red
  ...
  { bg: "bg-[#ca8a04]", text: "text-white", border: "border-[#854d0e]" }, // Gold / Ochre
  { bg: "bg-[#4f46e5]", text: "text-white", border: "border-[#4338ca]" }, // Indigo
  { bg: "bg-[#d97706]", text: "text-white", border: "border-[#b45309]" }, // Amber
  { bg: "bg-[#991b1b]", text: "text-white", border: "border-[#7f1d1d]" }, // Rich Red
