    ...
    <div className="space-y-6">
      ...
      <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <Button
            ...
            className="rounded-xl bg-[#881337] text-xs font-bold text-white shadow-sm hover:bg-[#9f1239] dark:bg-[#eab308] dark:text-[#0a0b0d] dark:hover:bg-[#facc15]"
          >
      ...
      <section className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <KpiCard
          ...
          value={summary.total}
          icon={UsersRound}
          color="bg-[#fff1f2] text-[#881337] border-[#fecdd3] dark:bg-[#881337]/20 dark:text-[#fca5a5] dark:border-[#881337]/30"
        />
        <KpiCard
          label="Citizens"
