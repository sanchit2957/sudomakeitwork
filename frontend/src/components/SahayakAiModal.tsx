      ...
      >
        ...
        <header className="flex items-center justify-between border-b border-neutral-100 px-5 py-3 dark:border-neutral-800">
          <div className="flex items-center gap-2.5">
            <div className="grid h-10 w-10 place-items-center rounded-2xl bg-[#881337] text-white shadow-sm dark:bg-[#eab308] dark:text-[#0a0b0d]">
              <Bot className="h-5 w-5" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-base" role="img" aria-label="robot">🤖</span>
                <h2 id="sahayak-ai-title" className="text-base font-extrabold tracking-tight text-foreground">
                  {t("Sahayak AI")}
                </h2>
              </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3.5">
          {/* Welcome Banner */}
          <div className="rounded-2xl bg-[#fff1f2] p-3.5 text-xs text-[#881337] ring-1 ring-[#881337]/15 dark:bg-[#450a0a]/30 dark:text-[#fca5a5] dark:ring-[#881337]/30">
              ...
              <div className="flex flex-wrap gap-1.5">
                {SUGGESTED_PROMPTS.map(({ icon, text }) => (
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-full border border-[#881337]/20 bg-white px-3 py-1.5 text-xs font-bold text-[#881337] shadow-2xs transition hover:border-[#881337] hover:bg-[#fff1f2] active:scale-95 dark:border-neutral-700 dark:bg-[#1a1a1c] dark:text-[#facc15] dark:hover:bg-neutral-800"
                  >
                    <span>{icon}</span>
                    <span>{t(text)}</span>
            ...
            >
              <div
                className={`max-w-[85%] rounded-2xl px-3.5 py-2.5 text-xs leading-relaxed ${
                  msg.role === "user"
                    ? "bg-[#881337] text-white rounded-br-xs shadow-xs dark:bg-[#eab308] dark:text-[#0a0b0d]"
                    : "bg-white text-foreground shadow-sm ring-1 ring-black/5 rounded-bl-xs dark:bg-[#1c1c1f] dark:ring-white/10"
                }`}
              >
        ...
        <footer className="border-t border-neutral-100 bg-white p-3.5 dark:border-neutral-800 dark:bg-[#121214]">
          <div className="flex items-center gap-2 rounded-2xl border border-neutral-200 bg-[#fcfdfd] px-3 py-1.5 shadow-2xs focus-within:border-[#881337] focus-within:ring-2 focus-within:ring-[#881337]/15 dark:border-neutral-700 dark:bg-[#1a1a1c] dark:focus-within:border-[#facc15]">
            <button
              type="button"
            ...
            <input
              ...
              className="flex-1 bg-transparent py-1.5 text-xs text-foreground placeholder:text-neutral-400 focus:outline-hidden dark:placeholder:text-neutral-500"
            />
            <button
              type="button"
              ...
              className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-[#881337] text-white transition active:scale-95 hover:bg-[#9f1239] disabled:cursor-not-allowed disabled:opacity-40 dark:bg-[#eab308] dark:text-[#0a0b0d] dark:hover:bg-[#facc15]"
            >
