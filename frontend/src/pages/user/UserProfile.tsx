  ...
  return (
    <div className="victim-page min-h-screen bg-[#f6f8f7] text-[#122824] transition-colors dark:bg-[#090a0a] dark:text-[#f3f4f6]">
      <main className="victim-main mx-auto min-h-screen max-w-lg bg-[#fcfdfd] px-5 pb-28 pt-6 transition-colors dark:bg-[#111214] md:my-6 md:min-h-[850px] md:rounded-[2.75rem] md:border dark:md:border-white/10">
        ...
        {/* User Hero Banner */}
        <section className="mt-4 rounded-[1.8rem] bg-gradient-to-br from-[#881337] via-[#4c0519] to-[#1c1917] p-5 text-white shadow-[0_12px_28px_rgba(136,19,55,0.25)] ring-1 ring-white/15">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-[#fde047]">{user?.email || t("Account verified")}</p>
                <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-white/20 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider text-white">
        ...
        {/* Feedback Alerts */}
        {saveSuccess && (
          <div className="mt-4 flex items-center gap-3 rounded-2xl border border-[#ca8a04]/30 bg-[#fefce8] p-4 text-[#854d0e] dark:border-[#eab308]/30 dark:bg-[#422006]/40 dark:text-[#fef08a]">
            <CheckCircle2 className="h-5 w-5 shrink-0 text-[#ca8a04] dark:text-[#facc15]" />
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      {contact.isPrimary === "yes" && (
                        <span className="inline-flex items-center gap-1 rounded-md bg-[#fef9c3] px-2 py-0.5 text-[10px] font-bold text-[#854d0e] dark:bg-[#422006] dark:text-[#fde047]">
                          <Star className="h-2.5 w-2.5 fill-[#ca8a04] text-[#ca8a04] dark:fill-[#facc15] dark:text-[#facc15]" />
                          {t("Primary")}
                        </span>
                      )}
                    </div>
                    <div className="flex flex-wrap items-center gap-3 text-xs font-semibold text-[#881337] dark:text-[#facc15]">
        ...
        <form onSubmit={handleSave} className="mt-5 space-y-5">
          ...
          <div className="rounded-[1.6rem] border border-black/5 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#16171a]">
            <div className="flex items-center gap-2 border-b border-black/5 pb-3 text-xs font-black uppercase tracking-wider text-[#881337] dark:border-white/10 dark:text-[#facc15]">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-muted-foreground">
                    <Phone className="h-4 w-4 text-[#881337] dark:text-[#facc15]" />
                  </span>
                  <Input
                    id="prof-phone"
                    value={phone}
            ...
            <div className="mt-4 space-y-3.5">
              <div>
                ...
                <select
                  ...
                  className="mt-1 block w-full rounded-xl border border-black/10 bg-[#f9faf9] px-3 py-2 text-xs font-semibold text-[#122824] focus:outline-none focus:ring-2 focus:ring-[#881337] dark:border-white/10 dark:bg-[#1c1d22] dark:text-[#f3f4f6]"
                >
                  {BLOOD_GROUPS.map((bg) => (
            ...
            <div className="mt-4 space-y-3.5">
              ...
              <div className="flex items-center justify-between gap-4 rounded-xl border border-black/5 bg-[#f9faf9] p-3 dark:border-white/10 dark:bg-[#1c1d22]">
                ...
                <input
                  ...
                  className="h-5 w-5 rounded border-gray-300 text-[#881337] focus:ring-[#881337]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 space-y-3">
            <Button
              type="submit"
              disabled={isSaving}
              className="w-full gap-2 rounded-2xl bg-[#881337] py-6 text-sm font-black text-white shadow-lg transition hover:bg-[#9f1239] active:scale-[.99] dark:bg-[#eab308] dark:text-[#0a0b0d] dark:hover:bg-[#facc15]"
            >
              {isSaving ? (
                <>
