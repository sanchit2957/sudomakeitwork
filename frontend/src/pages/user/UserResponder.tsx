...
export default function UserResponder() {
...
function ResponderWorkspace() {
  ...
  const liveMissionQuery = { refetchInterval: 3_000, refetchIntervalInBackground: true, refetchOnWindowFocus: true, refetchOnReconnect: true } as const;
  ...
  // When the offer clears (no longer active), resets tracking so the NEXT offer triggers fresh alert.
  useEffect(() => {
        ...
        {location === "/responder/map" ? (
          ...
          <>
            <section className={`grid gap-5 ${pushState === "subscribed" || Capacitor.isNativePlatform() ? "" : "lg:grid-cols-[1.25fr_0.75fr]"}`}>
              <div className="rounded-3xl bg-gradient-to-br from-[#4c0519] via-[#881337] to-[#9f1239] p-6 text-white shadow-[0_20px_60px_-30px_rgb(136_19_55/0.75)]">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3">
                  ...
                  {profile.data?.callSign && (
                    <span className="rounded-lg bg-white/15 px-2.5 py-1 font-mono text-xs font-bold text-[#facc15]">
                      {profile.data.callSign}
                    </span>
                  )}
                </div>
                <p className="mt-2 max-w-lg text-sm leading-6 text-[#fef08a]">
                    ...
                    <button
                      ...
                      className={`rounded-xl px-4 py-2.5 text-sm font-extrabold transition ${
                        profile.data?.availability === value
                          ? "bg-white text-[#881337] dark:bg-[#facc15] dark:text-[#0a0b0d]"
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        {activeMission ? (
          <div className="flex items-center gap-2 rounded-2xl border border-[#facc15]/40 bg-[#facc15]/20 px-3.5 py-2 text-xs font-bold text-[#854d0e] dark:text-[#facc15]">
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-[#881337]/30 bg-[#fff1f2] p-4 text-xs dark:bg-[#450a0a]/20 dark:border-[#881337]/40">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-2xl border bg-white p-4 shadow-sm dark:bg-card">
          ...
          <p className="text-[11px] text-[#ca8a04] dark:text-[#facc15] font-semibold">
        ...
        <div className="rounded-2xl border bg-white p-4 shadow-sm dark:bg-card">
          ...
          <p className="mt-1 text-2xl font-black text-[#881337] dark:text-[#facc15]">{totalEmergencyBeds}</p>
...
function HospitalDirectoryCard({
  ...
  return (
    <article className="rounded-2xl border bg-white p-5 shadow-sm transition hover:border-[#881337]/40 dark:bg-card dark:hover:border-[#facc15]/40">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span
                className={`rounded-full px-2.5 py-0.5 font-mono text-[10px] font-bold uppercase ${
                  hospital.status === "open"
                    ? "bg-[#fefce8] text-[#854d0e] dark:bg-[#422006]/40 dark:text-[#fef08a]"
              ...
              {isEnRoute && (
                <span className="rounded-full bg-[#facc15]/20 px-2.5 py-0.5 font-mono text-[10px] font-bold text-[#854d0e] ring-1 ring-[#facc15]/50 dark:text-[#facc15]">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            <div className="rounded-xl border bg-muted/30 p-2.5">
              ...
              <p className="mt-1 font-black text-sm text-[#881337] dark:text-[#facc15]">
          ...
          {activeMission && (
            <>
              ...
              <Button
                ...
                size="sm"
                onClick={onNotify}
                className="rounded-xl border-[#881337]/30 bg-[#881337]/10 text-xs font-bold text-[#881337] hover:bg-[#881337]/20 dark:border-[#facc15]/30 dark:bg-[#facc15]/10 dark:text-[#facc15] dark:hover:bg-[#facc15]/20"
              >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
      <div className="w-full max-w-md rounded-3xl border bg-card p-6 shadow-2xl space-y-4">
        ...
        {success && (
          <div className="rounded-xl bg-[#fefce8] p-3 text-xs font-bold text-[#854d0e] dark:bg-[#422006]/40 dark:text-[#fef08a]">
        ...
        <div className="rounded-2xl border bg-muted/40 p-4 space-y-2 text-xs">
          ...
          <div className="grid grid-cols-2 gap-2 pt-2">
            <div className="rounded-lg bg-background p-2 border">
              ...
              <div className="font-black text-[#881337] dark:text-[#facc15]">{hospital.availableEmergencyBeds || 0} available</div>
            </div>
            <div className="rounded-lg bg-background p-2 border">
  ...
  return (
    <div className="rounded-3xl border bg-white p-6">
      ...
      <button
        ...
        onClick={onEnable}
        disabled={isLocked}
        className="mt-4 w-full rounded-xl border border-[#881337]/40 px-4 py-2.5 text-sm font-bold text-primary transition hover:bg-[#881337]/10 dark:border-[#facc15]/40 dark:hover:bg-[#facc15]/10 disabled:cursor-not-allowed disabled:opacity-50"
      >
        {label}
      </button>
      {detail && (
    ...
    <section className="rounded-3xl border bg-white p-5 shadow-sm md:p-6">
      <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
        <div className="flex min-w-0 items-center gap-4">
          <div className="grid h-16 w-16 shrink-0 place-items-center overflow-hidden rounded-2xl bg-[#881337]/10 text-[#881337] dark:bg-[#eab308]/15 dark:text-[#facc15]">
        ...
        <label className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-[#881337]/40 px-4 py-2.5 text-sm font-bold text-primary hover:bg-[#881337]/10 dark:border-[#facc15]/40 dark:hover:bg-[#facc15]/10">
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_auto]">
        ...
        <label className="flex cursor-pointer items-center gap-3 rounded-2xl bg-black/5 dark:bg-white/5 px-4 py-3 text-sm font-semibold text-foreground">
          <input
            type="checkbox"
      ...
      {savedNotice && (
        <p className="mt-3 rounded-xl bg-[#fefce8] p-2.5 text-xs font-bold text-[#854d0e] dark:bg-[#422006]/30 dark:text-[#fef08a]">
      ...
      <div
        className={`mt-6 rounded-2xl border p-4 ${
          hasActiveMission ? "border-[#881337]/30 bg-[#fff1f2] dark:bg-[#450a0a]/20 dark:border-[#881337]/40" : "border-border bg-muted/40"
        }`}
      >
        <div className="flex gap-3">
          ...
          <div>
            ...
            {hasActiveMission && (
              <span className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#fefce8] px-3 py-1.5 text-xs font-bold text-[#854d0e] dark:bg-[#422006]/30 dark:text-[#fef08a]">
...
function RescuerRegistration() {
  ...
  return (
    <div className="relative min-h-screen app-grid flex items-center justify-center p-5">
      ...
      <section className="w-full max-w-lg rounded-[2rem] border bg-white dark:bg-card p-6 shadow-xl">
        <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#881337]/10 text-[#881337] dark:bg-[#eab308]/15 dark:text-[#facc15]">
        ...
        {isPendingReview && (
          <div className="mt-4 rounded-2xl border border-[#881337]/30 bg-[#fff1f2] p-4 text-xs leading-5 text-[#881337] dark:bg-[#450a0a]/30 dark:text-[#fca5a5]">
        ...
        <Button
          ...
          className="mt-6 w-full rounded-xl bg-[#881337] text-white hover:bg-[#9f1239] dark:bg-[#eab308] dark:text-[#0a0b0d] dark:hover:bg-[#facc15]"
        >
          {request.isPending
            ? t("Sending request…")
            : isPendingReview
        ...
        {request.isSuccess && (
          <p className="mt-4 rounded-xl bg-[#fefce8] p-3 text-sm font-semibold text-[#854d0e] dark:bg-[#422006]/30 dark:text-[#fef08a]">
  ...
  return (
    <section className="space-y-4">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        ...
        />
        <div className="flex items-center gap-2 self-start rounded-full border border-[#facc15]/40 bg-[#fefce8] px-3 py-1 text-xs font-semibold text-[#854d0e] dark:bg-[#422006]/40 dark:text-[#fef08a]">
        ...
        {validItems.length ? (
          validItems.map(alert => (
            <button
              ...
              className={`rounded-2xl border p-4 text-left transition hover:border-[#881337]/40 dark:hover:border-[#facc15]/40 ${
                alert.readAt
                  ? "bg-white dark:bg-card"
                  : "bg-[#fff1f2] dark:bg-[#450a0a]/20 border-[#881337]/40 dark:border-[#facc15]/40"
              }`}
            >
            ...
            <div
              ...
              className={`max-w-[85%] rounded-2xl px-3 py-2 text-xs leading-5 ${
                item.authorType === "rescuer"
                  ? "ml-auto bg-[#881337] text-white"
                  : "bg-white text-foreground dark:bg-background dark:text-foreground"
              }`}
            >
  ...
  return (
    <span
      className={`rounded-full px-2.5 py-1 font-mono text-[10px] font-bold uppercase ${
        status === "resolved"
          ? "bg-[#fefce8] text-[#854d0e] dark:bg-[#422006]/30 dark:text-[#fef08a]"
          : status === "dispatched"
...
function UserRescuerMissionCard({
  mission,
  incident,
  hospitals,
  onUpdateStatus,
  ...
  const handleSelectHospital = (e: React.FormEvent) => {
    e.preventDefault();
  ...
  const currentHospital = hospitals.find(h => h.id === Number(selectedHospitalId)) || hospitals[0];
      ...
      <div>
        <div className="flex flex-wrap items-center gap-2">
          ...
          {incident.destinationHospitalName && (
            <span className="rounded-full bg-[#facc15]/20 px-2.5 py-0.5 font-mono text-[10px] font-bold text-[#854d0e] ring-1 ring-[#facc15]/40 dark:text-[#facc15]">
      ...
      <div className="flex flex-col items-start gap-2 md:items-end md:justify-center">
        <div className="flex flex-wrap items-center gap-2">
          {mission.status !== "resolved" && (
            ...
            >
              <Hospital className="mr-1.5 h-3.5 w-3.5" />
              {incident.destinationHospitalName ? "Change Hospital" : "Route to Hospital"}
            </Button>
          )}

          {mission.status === "resolved" ? (
            <span className="flex items-center gap-2 text-sm font-bold text-[#881337] dark:text-[#facc15]">
          ...
          <div className="w-full max-w-lg rounded-3xl border bg-card p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-base font-extrabold">Select Destination Hospital Handoff</h3>
                  <p className="text-xs text-muted-foreground">SOS #{incident.publicCode} · Live Availability</p>
                </div>
              </div>
              <button
                type="button"
            ...
            {successNotice && (
              <div className="rounded-xl bg-[#fefce8] p-3 text-xs font-bold text-[#854d0e] dark:bg-[#422006]/40 dark:text-[#fef08a]">
                ✓ Hospital destination assigned! Patient and map routing updated.
              </div>
            )}

            <form onSubmit={handleSelectHospital} className="space-y-4">
              <div>
                <Label className="text-xs font-bold">Choose Hospital Facility</Label>
                <select
              ...
              {currentHospital && (
                <div className="rounded-2xl border border-[#881337]/20 bg-[#fff1f2] dark:border-[#facc15]/20 dark:bg-[#450a0a]/20 p-4 space-y-2.5 text-xs">
                  <div className="font-extrabold text-sm text-primary flex items-center gap-1.5">
                    <span>🏥</span> {currentHospital.name}
                  </div>
                  <div className="text-muted-foreground flex items-center gap-1">
                    <span>📍</span> {currentHospital.address}
                  </div>
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div className="rounded-xl bg-white p-2.5 border dark:bg-card">
                      <div className="text-[10px] uppercase font-bold text-muted-foreground">Bed Capacity</div>
                      <div className="font-black text-sm text-[#881337] dark:text-[#facc15]">
                        {currentHospital.totalEmergencyBeds + currentHospital.totalIcuBeds} total beds
                      </div>
                      <div className="text-[10px] text-muted-foreground">
                        ER: {currentHospital.totalEmergencyBeds} · ICU: {currentHospital.totalIcuBeds}
                      </div>
                    </div>
                    <div className="rounded-xl bg-white p-2.5 border dark:bg-card">
                      ...
                      <div className="font-black text-sm text-sky-700 dark:text-sky-400">
                        {currentHospital.totalEmergencyBeds +
                          currentHospital.totalIcuBeds -
                          (currentHospital.availableEmergencyBeds + currentHospital.availableIcuBeds)}{" "}
                        occupied
                      </div>
                      <div className="text-[10px] text-[#ca8a04] font-bold dark:text-[#facc15]">
                        {currentHospital.availableEmergencyBeds + currentHospital.availableIcuBeds} beds available
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <Button type="submit" disabled={selectHospital.isPending} className="rounded-xl bg-primary text-white">
                  {selectHospital.isPending ? "Assigning…" : "Confirm Hospital Route"}
                </Button>
              </div>
            </form>
          </div>
