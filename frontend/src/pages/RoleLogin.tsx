      ...
      <main className="mx-auto max-w-md px-4 py-8 md:py-12">
        ...
        <div className="mt-4 overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm dark:border-white/10 dark:bg-[#141517]">
          ...
          <div className="p-5 sm:p-6">
            ...
            {successMessage && (
              <div className="mb-5 flex items-start gap-2.5 rounded-2xl border border-[#ca8a04]/30 bg-[#fefce8] p-3.5 text-xs font-semibold text-[#854d0e] dark:border-[#eab308]/30 dark:bg-[#422006]/30 dark:text-[#fef08a]">
